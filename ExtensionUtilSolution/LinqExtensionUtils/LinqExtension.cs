...
namespace LinqExtensionUtils
{
    ...
    public static class LinqExtension
    {
        ...
        public static IEnumerable<T> OrderBy<T>(this IEnumerable<T> source, string property)
        {
            return ApplyOrder<T>(source, property, "OrderBy");
        }
        ...
        public static IEnumerable<T> OrderByDescending<T>(this IEnumerable<T> source, string property)
        {
            return ApplyOrder<T>(source, property, "OrderByDescending");
        }
        ...
        public static IEnumerable<T> ThenBy<T>(this IEnumerable<T> source, string property)
        {
            return ApplyOrder<T>(source, property, "ThenBy");
        }
        ...
        public static IEnumerable<T> ThenByDescending<T>(this IEnumerable<T> source, string property)
        {
            return ApplyOrder<T>(source, property, "ThenByDescending");
        }
        ...
        static IEnumerable<T> ApplyOrder<T>(IEnumerable<T> source, string property, string methodName)
        {
            string[] props = property.Split('.');
            Type type = typeof(T);
            ParameterExpression arg = Expression.Parameter(type, "x");
        ...
        public static IEnumerable<T> Distinct<T>(this IQueryable<T> source, Func<T, object> propertySelector)
        {
            return source.GroupBy(propertySelector).Select(x => x.First());
        }

        public static IEnumerable<T> Distinct<T>(this IEnumerable<T> source, Func<T, object> propertySelector)
        {
            return source.GroupBy(propertySelector).Select(x => x.First());
        }

        /// <summary>
        /// Use only for List in Memory
        /// </summary>
