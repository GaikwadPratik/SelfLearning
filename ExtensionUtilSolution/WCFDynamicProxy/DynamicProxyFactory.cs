...
namespace WCFDynamicProxy
{
    public class DynamicProxyFactory
    {
        ...
        private void CreateServiceContractGenerator()
        {
            ...
            this.contractGenerator.Options |= ServiceContractGenerationOptions.ClientClass | ServiceContractGenerationOptions.TaskBasedAsynchronousMethod;
        }
