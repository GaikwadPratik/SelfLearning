var cityTypeAheadController = function ($scope, serverCallMakerFactory, focusFactory) {
    $scope.selectedCity = '';
    $scope.selectedArea = '';
    ...
    $scope.createUrlParams = function () {
        $('#hdnCityAreaService').val(cityId + ';' + areaId + ';' + serviceId);
    }

    var init = function () {        
        focusFactory.focus('txtCity');
    }
